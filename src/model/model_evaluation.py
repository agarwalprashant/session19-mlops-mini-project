...
# repo_owner = "agarwalprashant"
# repo_name = "session19-mlops-mini-project"
...
def main():
    ...
    with mlflow.start_run() as run:  # Start an MLflow run
        try:
            ...
            # Log model to MLflow and capture the model info
            model_info = mlflow.sklearn.log_model(clf, artifact_path="model")
            
            # Save model info with the actual model_uri
